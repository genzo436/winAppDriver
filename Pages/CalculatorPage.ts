import { PageObject, By2, WebDriver2 } from "selenium-appium";
...
class CalculatorPage extends PageObject {
  ...
  get clearButton() { return By2.nativeAccessibilityId('clearButton'); }
  get plusButton() { return By2.nativeAccessibilityId('plusButton'); }
  get divideButton() { return By2.nativeAccessibilityId('divideButton'); }
  get multiplyButton() { return By2.nativeXpath("//Button[@Name='Multiplicar por']") }
